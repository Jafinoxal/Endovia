...
def MainDungeonGenerator(objects, characters, chart, rooms, player_character_id, enemy_character_id):
    ...
    character_positions = chart._place_enemies_start(objects, characters, 2001, enemy_character_id)
