...
def _name():
    ...
    1: "Satiation Scroll",
    2: "Holy Light Scroll",
    3: "Unholy Light Scroll",
    4: "Phase Scroll",
    5: "Blink Scroll",
    6: "Tangibility Scroll",
    7: "Caution Scroll",
    8: "Mapping Scroll",
    9: "Recall Scroll",
    10: "Bouyancy Scroll",
...
def _description():
    return {
    0: "Puts to sleep monsters in the immediate area.",
    1: "Satisfies hunger, removes bloated stomach.",
    2: "Radiates light from player and scares away unholy monsters.",
    3: "Radiates light from player and scares away holy monsters.",
    4: "Teleports player in the immediate area.",
    5: "Teleports player in a random area.",
    6: "Removes invisibility from invisible monsters.",
    7: "Makes traps visible in the immediate area.",
    8: "Maps out random spots on the map.",
    9: "Teleports player to nearest town, or back to dungeon.",
    10: "Allows player to walk on water.",
    11: "Allows player to breathe under water.",
    12: "Silences player movement.",
    13: "Makes player invisible.",
    14: "Floods immediate area with shallow water.",
    15: "Smooth talk your way into anything.",
    16: "Sends monsters in the immediate area into a frenzy.",
    17: "Spawns a diety minion of your religion.",
    }
